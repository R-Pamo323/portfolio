...
export const Cabecera = () => {
  ...
  // función para cerrar cuando se hace click en un link
  const closeMenu = () => {
    setMenuOpen(false);
  };
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 10) {
        setShowLogoText(false); // Mostrar cuando está arriba
      } else {
        setShowLogoText(true); // Ocultar cuando baja
      }
    };
    ...
    <>
      <header className="header">
        <div className="logo-menu">
          <a href="#inicio" className="rlogo-link">
            <svg
              viewBox="0 0 64 64"
            ...
            >
              <path d="M36.604 23.043c-.623-.342-1.559-.512-2.805-.512h-6.693v7.795h6.525c1.295 0 2.268-.156 2.916-.473c1.146-.551 1.721-1.639 1.721-3.268c0-1.757-.555-2.939-1.664-3.542"></path>
          ...
          <a
            href="#inicio"
            className={`rlogo-text ${showLogoText ? "visible" : "hidden"}`}
          >
            odrigo Pamo
          </a>

      ...
      <div className="container">
        ...
        <article className="contact-cards">
          ...
          <aside className="contact-card box-shadow-1">
            ...
            <h5>EMAIL</h5>
            <small>
              <a href="mailto:rey_pamoide@hotmail.com">
                rodrigopamo323@gmail.com
              </a>
            </small>
          </aside>
          <aside className="contact-card box-shadow-1">
            ...
            <small className="social-media">
              <a
                href="https://github.com/R-Pamo323"
                target="_blank"
                rel="noopener"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/in/rodrigopamodelgado/"
                target="_blank"
                rel="noopener"
              >
                <svg
